...
<template>
  <div>
    ...
    <pagination
      ...
      @on-load="loadData"
    ></pagination>
    <Modal v-model="enterpriseFlag" title="企业认证"></Modal>
...
export default {
    name: "wallet-enterprise-account",
    data() {
        return {
            yueModal: false,
                                ...
                                "Button",
                                {
                                    ...
                                    on: {
                                        click: () => {
                                            this.$router.push({
                                                name:
                                                    "wallet-enterprise-account-detail",
                                                params: {
    ...
    methods: {
        ...
        loadData() {
            this.loading = true;
            getWalletAccountList("ent", this.filter).then(res => {
                this.loading = false;

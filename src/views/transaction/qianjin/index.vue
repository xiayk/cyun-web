  ...
  <div>
    <Card class="filter-wrap">
      ...
      >
        ...
        <FormItem label="机构号">
          <Input v-model="filter.organNo"></Input>
        </FormItem>
        ...
        <FormItem label="金额">
          <Input v-model="filter.amount"></Input>
        </FormItem>
        <FormItem label="交易状态">
          <Select transfer v-model="filter.state" clearable>
            <Option value="00">付款成功</Option>
            <Option value="01">付款失败</Option>
            <Option value="09">付款中</Option>
            <Option value="10">付款成功-推送失败</Option>
            <Option value="11">付款成功-推送成功</Option>
          </Select>
        </FormItem>
    ...
    <div class="data-control">
      <Button @click="handleBatchPush" :loading="loading">批量更新</Button>
    </div>
    <Table
...
let timeOuter = "";
export default {
    name: "transaction-qianjin-order-flow",
    data() {
        return {
            modalLoading: true,
    ...
    methods: {
        loadData() {
            this.loading = true;
            getQianjinOrderList(this.filter).then(
                res => {
                    this.loading = false;
